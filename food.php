...
<body>
    ...
    <div class="panel container text-center h-5 mt-3">
        <h1>Swasth</h1>
        <p>Welcome to Thali - Traditional Indian Food</p>
    </div>
    ...
    <div class="container ">
        <div class="row">
            <div class="card my-4 h-20 col-md-12 p-4 m-4" style="width: 25rem;">
                <img src="img/Thali - Traditional Indian Food.jpeg" class="card-img-top h-250" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Thali - Traditional Indian Food</h5>
                    <p class="card-text">
                    <ul>
                        <li>protein 10%</li>
                        <li>fat 10%</li>
