...
<head>
    ...
    <title>Sourth Indian Food</title>
...
<body>
    ...
    <div class="panel container text-center h-5 mt-3">
        <h1>Swasth</h1>
        <p>Welcome to our South Indian Food</p>
    </div>
    ...
    <div class="container ">
        <div class="row">
            <div class="card my-4 h-20 col-md-8 p-4 m-4" style="width: 25rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Ghee roast Dosa and Idlii</h5>
                    <p class="card-text">
                    <ul>
                        <li>protein 10%</li>
                        <li>fat 10%</li>
            ...
            <div class="card my-4 h-20 row- col-md-6" style="width: 25rem;">
                <img src="img/Ven pongal traditional indian food.jpeg"
                    class="card-img-top h-250" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Ven pongal traditional indian food</h5>
                    <p class="card-text">
                    <ul>
                        <li>protein 10%</li>
                        <li>fat 10%</li>
            ...
            <div class="card my-4 h-20 col-md-6 m-4" style="width: 25rem;">
                <img src="img/Masala vada- spicy fried fritters.jpeg" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Masala vada- spicy fried fritters</h5>
                    <p class="card-text">
                    <ul>
                        <li>protein 10%</li>
                        <li>fat 10%</li>
